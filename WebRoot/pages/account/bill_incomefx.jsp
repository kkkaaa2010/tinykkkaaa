...
<script type="text/javascript">
	$(document).ready(function(){
		$.ajax({
	         url: "<%=request.getContextPath()%>/sh/account/fx/initIncomefx.do",
	         type: "post",
	         dataType:"json",
	         success: function(data) {
				var legendData 	= data.legendData;
				var seriesData 	= data.seriesData;
				drawIncomeFx(legendData, seriesData);
		     },
		     error: function(e) {
		   	 	alert("error!"); 
		   	 } 
...
<body>
    ...
    <div id="incomePie" style="width:100%;height:400px;"></div>
</body>
</html>